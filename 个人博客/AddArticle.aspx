<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddArticle.aspx.cs" Inherits="个人博客.AddProduct" %><%@ Register assembly="CuteEditor" namespace="CuteEditor" tagprefix="CE" %>
...
<body>
    ...
    <div style="padding: 0px; margin: 0px; background-color: #212A38; width: 100%; height:800px; top: 0px;left: 0px; position: absolute; z-index: auto; clear: both;">
        <br /><br /><br />
    ...
    <div id="box-1" class="hidden-box">
        ...
        <tr>
            <td></td>
            <td align="right" style="color: #FFFFFF">描述:</td>
            <td >
            ...
            <td></td>
            <td align="right" style="color: #FFFFFF">图片:</td>
            <td align="left">
        ...
        <tr>
            <td style="border-top: 1px solid #33CC33; height: 25px; text-align: center; " colspan="3">                
